...
import org.influxdb.msgpack.Lz4PackConverterFactory;
...
public class InfluxDBImpl implements InfluxDB {
  ...
  private final Lz4RequestInterceptor lz4RequestInterceptor;
  ...
  public InfluxDBImpl(final String url, final String username, final String password,
    ...
    this.lz4RequestInterceptor = new Lz4RequestInterceptor();
    OkHttpClient.Builder clonedOkHttpBuilder = okHttpBuilder.build().newBuilder()
            .addInterceptor(loggingInterceptor)
            .addInterceptor(lz4RequestInterceptor)
    ...
    case JSON:
    default:
      converterFactory = Lz4PackConverterFactory.create();
   ...
   */
  @Override
  public InfluxDB enableLz4() {
    this.lz4RequestInterceptor.enable();
    return this;
  }
   ...
   */
  @Override
  public InfluxDB disableLz4() {
    this.lz4RequestInterceptor.disable();
    return this;
  }
   ...
   */
  @Override
  public boolean isLz4Enabled() {
    return this.lz4RequestInterceptor.isEnabled();
  }
